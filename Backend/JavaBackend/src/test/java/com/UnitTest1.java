  ...
  public void testCase7() throws Exception {
    this.run(
        () -> {
          ...
          list.add(
            new Message("abcd", "abcd1", "messagetest1", "", MessageContentType.CONTENT_NONE)
          );
          list.add(
            new Message("abcd", "abcd1", "messagetest2", "", MessageContentType.CONTENT_NONE)
          );
          list.add(
            new Message("abcd", "abcd1", "messagetest3", "", MessageContentType.CONTENT_NONE)
          );
          list.add(
            new Message("abd", "abcd1", "messagetest1", "", MessageContentType.CONTENT_NONE)
          );
  ...
  public void testCase8() throws Exception {
    this.run(
        () -> {
          ...
          list.add(
            new Message("abcd1", "abcd", "messagetestBonus", "", MessageContentType.CONTENT_NONE)
          );
          list.add(
            new Message("abd", "abcd1", "messagetest1", "", MessageContentType.CONTENT_NONE)
          );
          ...
          List<Message> mes1 =
            this.messageDao.getMessageByConversation(new Conversation("abcd", "abcd1"));
